...
`**观看视频: 《润普档案管理系统的使用》** <../tour/flash/#id4>`__
...
使用润普档案管理系统，可全面管理电子档案资料 ，从电子档案的收集、入库、整理、发布、归档、查询、借阅、销毁等方面进行全过程控制和管理，实现档案信息管理传输的自动化、档案资料一体化、标准化、规范化和共享化。

润普档案管理系统广泛应用于以下行业：国家政府机关、能源部门（电力、石油石化、煤炭）、水利部门、冶金部门、铁路部门、通信行业、机电兵船行业、交通、金融保险、建设行业、图书馆、档案馆以及中大型企业。
...
OCR智能识别和转换
=====================
润普档案管理系统采用自动OCR识别技术，把档案扫描件自动进行文字分拣和处理。同时，可把档案原件直接转换成双层PDF文档，实现无差别转换，同时，也方便了查询。
...
数据统计和报表
=========================
润普档案管理系统当中，提供各种统计报表，方便对档案管理工作的监控、评估和管理
